...
public class FetchPhase implements SearchPhase {
    ...
    public void execute(SearchContext context, TransactionContext transactionContext) {
        ...
        context.fetchResult().hits(new InternalSearchHits(hits, context.queryResult().topDocs().totalHits, context.queryResult().getNetCount(), context.queryResult().topDocs().getMaxScore()));
    }
